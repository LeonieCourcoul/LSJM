logR_llh_lsjm_classicCR <- function(param,hazard_baseline_01, sharedtype_01,
  ...
  sharedtype <- c("current value" %in% sharedtype_01, "slope" %in% sharedtype_01,
                  "current value" %in% sharedtype_02, "slope" %in% sharedtype_02
  )
  ...
  B_T_02 <- Matrices[["B_T_02"]]; Bs_T_02 <- Matrices[["Bs_T_02"]];
    ...
    Bs_T0_01 <- Matrices[["Bs_T0_01"]] ; Bs_T0_02 <- Matrices[["Bs_T0_02"]]
