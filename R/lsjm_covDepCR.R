lsjm_covDepCR <- function(Objectlsmm, Time, deltas, hazard_baseline_01, hazard_baseline_02, nb.knots.splines,
  ...
  estimation1 <- marqLevAlg(binit, fn = logR_llh_lsjm_covDepCR, minimize = FALSE,
  ...
  estimation2 <- marqLevAlg(estimation1$b, fn = logR_llh_lsjm_covDepCR, minimize = FALSE,
