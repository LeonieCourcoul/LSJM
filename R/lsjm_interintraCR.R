lsjm_interintraCR <- function(Objectlsmm, Time, deltas, hazard_baseline_01, hazard_baseline_02, nb.knots.splines,
  ...
  estimation2 <- marqLevAlg(estimation1$b, fn = logR_llh_lsjm_interintraCR, minimize = FALSE,
  ...
  class(result) <- c("lsjm_interintraCR")
  return(result)
