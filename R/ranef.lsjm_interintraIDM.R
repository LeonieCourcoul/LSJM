...
ranef.lsjm_interintraIDM <- function(object,...){
  ...
  if(x$control$Objectlsmm$control$var_inter && x$control$Objectlsmm$control$var_intra){
    random.effects.Predictions <- matrix(NA, nrow = nbCase1+nbCase1bis+nbCase2+nbCase3, ncol = x$control$Objectlsmm$control$nb.e.a+2+1)
    binit <- matrix(0, nrow = 1, ncol = x$control$Objectlsmm$control$nb.e.a+2)
  }
  else{
    if(x$control$Objectlsmm$control$var_inter || x$control$Objectlsmm$control$var_intra){
      random.effects.Predictions <- matrix(NA, nrow = nbCase1+nbCase1bis+nbCase2+nbCase3, ncol = x$control$Objectlsmm$control$nb.e.a+1+1)
      binit <- matrix(0, nrow = 1, ncol = x$control$Objectlsmm$control$nb.e.a+1)
    }
    else{
      random.effects.Predictions <- matrix(NA, nrow = nbCase1+nbCase1bis+nbCase2+nbCase3, ncol = x$control$Objectlsmm$control$nb.e.a+1)
  ...
  if(length(id.Case1)>0){
    ...
    ID.visit <- data.long.Case1[all.vars(x$control$Objectlsmm$control$formGroupVisit)][,1]; offset <- list.long.Case1$offset
    ...
    for(id.Case1_boucle in 1:nbCase1){
      ...
      ID.visit_i <- ID.visit[offset[id.Case1_boucle]:(offset[id.Case1_boucle+1]-1)]
      offset_ID_i <- as.vector(c(1, 1 + cumsum(tapply(ID.visit_i, ID.visit_i, length))))
      ...
      random.effects_i <- marqLevAlg(binit, fn = re_lsjm_interintraIDMCase1, minimize = FALSE, nb.e.a = x$control$Objectlsmm$control$nb.e.a, variability_inter_visit = x$control$Objectlsmm$control$var_inter,
                                     ...
                                     Uslope_GK_T_i = Uslope_GK_T_i, X_GK_L_R_i = X_GK_L_R_i,  U_GK_L_R_i = U_GK_L_R_i,  Xslope_GK_L_R_i = Xslope_GK_L_R_i,  Uslope_GK_L_R_i = Uslope_GK_L_R_i,
                                     ...
                                     len_visit_i = len_visit_i, X_base_i = X_base_i, U_base_i = U_base_i, y_i = y_i, offset_ID_i = offset_ID_i, index_b_slope = x$control$index_b_slope,
      ...
      cv.Pred <- rbind(cv.Pred, cbind(rep(data.id.Case1$id[id.Case1_boucle], length(CV)),
                                      time.measures_i, CV,  rep(Varia.inter, length(CV)), rep(Varia.intra, length(CV))))
    }
  ...
  if(length(id.Case1bis)>0){
    ...
    ID.visit <- data.long.Case1bis[all.vars(x$control$Objectlsmm$control$formGroupVisit)][,1]; offset <- list.long.Case1bis$offset
    ...
    for(id.Case1bis_boucle in 1:nbCase1bis){
      ...
      ID.visit_i <- ID.visit[offset[id.Case1bis_boucle]:(offset[id.Case1bis_boucle+1]-1)]
      offset_ID_i <- as.vector(c(1, 1 + cumsum(tapply(ID.visit_i, ID.visit_i, length))))
      len_visit_i <- length(unique(ID.visit_i))
      ...
      random.effects_i <- marqLevAlg(binit, fn = re_lsjm_interintraIDMCase1Bis, minimize = FALSE,nb.e.a = x$control$Objectlsmm$control$nb.e.a, variability_inter_visit = x$control$Objectlsmm$control$var_inter,
                                     ...
                                     delta2_i = delta2_i, Z_01_i=Z_01_i, Z_02_i=Z_02_i, Z_12_i=Z_12_i, X_T_i=X_T_i,  U_T_i=U_T_i,
                                     Xslope_T_i = Xslope_T_i,  Uslope_T_i = Uslope_T_i,  X_GK_T_i=X_GK_T_i,  U_GK_T_i=U_GK_T_i,  Xslope_GK_T_i=Xslope_GK_T_i,
                                     Uslope_GK_T_i=Uslope_GK_T_i,  X_L_i=X_L_i,  U_L_i=U_L_i,
                                     Xslope_L_i=Xslope_L_i,  Uslope_L_i=Uslope_L_i,  X_GK_L_i=X_GK_L_i,  U_GK_L_i=U_GK_L_i,  Xslope_GK_L_i=Xslope_GK_L_i,
                                     Uslope_GK_L_i=Uslope_GK_L_i,
                                     X_GK_T0_i=X_GK_T0_i,  U_GK_T0_i=U_GK_T0_i,  Xslope_GK_T0_i=Xslope_GK_T0_i,  Uslope_GK_T0_i=Uslope_GK_T0_i,
  ...
  if(length(id.Case2)>0){
    ...
    ID.visit <- data.long.Case2[all.vars(x$control$Objectlsmm$control$formGroupVisit)][,1]; offset <- list.long.Case2$offset
    ...
    for(id.Case2_boucle in 1:nbCase2){
      ...
      ID.visit_i <- ID.visit[offset[id.Case2_boucle]:(offset[id.Case2_boucle+1]-1)]
      offset_ID_i <- as.vector(c(1, 1 + cumsum(tapply(ID.visit_i, ID.visit_i, length))))
      len_visit_i <- length(unique(ID.visit_i))
  ...
  if(length(id.Case3)>0){
    ...
    ID.visit <- data.long.Case3[all.vars(x$control$Objectlsmm$control$formGroupVisit)][,1]; offset <- list.long.Case3$offset
    ...
    for(id.Case3_boucle in 1:nbCase3){
      ...
      ID.visit_i <- ID.visit[offset[id.Case3_boucle]:(offset[id.Case3_boucle+1]-1)]
      offset_ID_i <- as.vector(c(1, 1 + cumsum(tapply(ID.visit_i, ID.visit_i, length))))
      len_visit_i <- length(unique(ID.visit_i))
      random.effects_i <- marqLevAlg(binit, fn = re_lsjm_interintraIDMCase3, minimize = FALSE,nb.e.a = x$control$Objectlsmm$control$nb.e.a, variability_inter_visit = x$control$Objectlsmm$control$var_inter,
                                     ...
                                     delta2_i = delta2_i, Z_01_i=Z_01_i, Z_02_i=Z_02_i, Z_12_i=Z_12_i, X_T_i=X_T_i,  U_T_i=U_T_i,
                                     Xslope_T_i = Xslope_T_i,  Uslope_T_i = Uslope_T_i,  X_GK_T_i = X_GK_T_i,  U_GK_T_i = U_GK_T_i,  Xslope_GK_T_i = Xslope_GK_T_i,
                                     Uslope_GK_T_i = Uslope_GK_T_i,  X_GK_L_T_i = X_GK_L_T_i,  U_GK_L_T_i = U_GK_L_T_i,  Xslope_GK_L_T_i = Xslope_GK_L_T_i,  Uslope_GK_L_T_i = Uslope_GK_L_T_i,
