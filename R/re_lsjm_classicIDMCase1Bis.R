...
re_lsjm_classicIDMCase1Bis <- function(param, nb.e.a, Sigma.re,
  ...
  log_f_Y_f_T <- re_lsjm_classicIDMCase1Bis_cpp( sharedtype,  HB,  Gompertz,  Weibull,
                                                    nb_pointsGK,
                                                    alpha_y_slope, alpha_b_01, alpha_b_02, alpha_b_12, alpha_z,  gamma_z0,  beta,  beta_slope,
