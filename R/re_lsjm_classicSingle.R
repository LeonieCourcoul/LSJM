...
re_lsjm_classicSingle <- function(param, nb.e.a,  Sigma.re,
                              sharedtype, HB, Gompertz, Weibull, nb_pointsGK,
                              alpha_y_slope, alpha_b_01, alpha_z,  gamma_z0,  beta,  beta_slope,  wk,
                              sigma_epsilon,
  ...
  log_f_Y_f_T <- re_lsjm_classicSingle_cpp(  sharedtype,  HB,  Gompertz,  Weibull,
                                         nb_pointsGK ,
                                         alpha_y_slope,  alpha_b_01, alpha_z,  gamma_z0,  beta,  beta_slope,
                                         b_y=t(matrix(b_re, nrow = 1)),  b_y_slope= t(matrix(b_y_slope, nrow = 1)),  wk,  sigma_epsilon,
                                         delta1_i, Z_01_i,  X_T_i,  U_T_i,
                                         Xslope_T_i,  Uslope_T_i,  X_GK_T_i,  U_GK_T_i,  Xslope_GK_T_i,
                                         Uslope_GK_T_i,
                                         X_GK_T0_i,  U_GK_T0_i,  Xslope_GK_T0_i,  Uslope_GK_T0_i,
