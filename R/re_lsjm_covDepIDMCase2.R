...
re_lsjm_covDepIDMCase2 <- function(param, nb.e.a, nb.e.a.sigma,  Sigma.re,
                                    ...
                                    alpha_y_slope_var, alpha_b_01, alpha_b_02, alpha_z,  gamma_z0,  beta,  beta_slope, omega,  wk,
  ...
  log_f_Y_f_T <- re_lsjm_covDepIDMCase2_cpp(  sharedtype,  HB,  W_G,
                                               nb_pointsGK ,
                                               alpha_y_slope_var, alpha_b_01, alpha_b_02, alpha_z,  gamma_z0,  beta,  beta_slope, omega,
