...
re_lsjm_interintraIDMCase1 <- function(param, nb.e.a, variability_inter_visit, variability_intra_visit, Sigma.re,
                                   sharedtype, HB, W_G, nb_pointsGK,
                                   alpha_y_slope, alpha_inter_intra, alpha_b_01, alpha_b_02, alpha_b_12,alpha_z,  gamma_z0,  beta,  beta_slope,  wk, rep_wk,
  ...
  log_f_Y_f_T <- re_lsjm_interintraIDMCase1_cpp(sharedtype, HB, W_G,
                                                nb_pointsGK, alpha_inter_intra,
                                                alpha_y_slope, alpha_b_01, alpha_b_02, alpha_b_12,
                                                alpha_z,  gamma_z0,  beta,  beta_slope,b_y = t(matrix(b_re, nrow = 1)),
                                                b_y_slope= t(matrix(b_y_slope, nrow = 1)),  wk, rep_wk, sigma_inter_intra,
                                                delta2_i, Z_01_i, Z_02_i, Z_12_i, X_T_i,  U_T_i,
                                                Xslope_T_i,  Uslope_T_i,  X_GK_T_i,  U_GK_T_i,  Xslope_GK_T_i,
                                                Uslope_GK_T_i,  X_GK_L_R_i,  U_GK_L_R_i,  Xslope_GK_L_R_i,  Uslope_GK_L_R_i,
                                                X_GK_0_LR_i,  U_GK_0_LR_i,  Xslope_GK_0_LR_i,  Uslope_GK_0_LR_i,
