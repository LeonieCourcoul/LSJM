re_lsjm_interintraIDMCase3 <- function(param, nb.e.a, variability_inter_visit, variability_intra_visit, Sigma.re,
                          ...
                          alpha_y_slope, alpha_z,  gamma_z0,  beta,  beta_slope,  wk, rep_wk,
  ...
  log_f_Y_f_T <- re_lsjm_interintraIDMCase3_cpp(sharedtype, HB, Gompertz, Weibull,
                                      nb_pointsGK, alpha_inter_intra,
                                      alpha_y_slope, alpha_b,
