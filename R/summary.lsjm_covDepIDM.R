...
summary.lsjm_covDepIDM <- function(object,...)
{
  ...
  cat("Location-scale joint model for an illness-death model fitted by maximum likelihood method", "\n")
  ...
  e12_surv_tab <- rbind(e12_share_random_tab, e12_share_current_tab, e12_share_slope_tab, e12_share_var_tab, e12_alpha_tab)
