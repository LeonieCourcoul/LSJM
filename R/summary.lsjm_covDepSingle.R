...
summary.lsjm_covDepSingle <- function(object,...)
{
  x <- object
  ...
  cat("Joint location-scale model with covariate and time-dependent residual variability for quantitative outcome and a single event", "\n")
