...
arma::vec log_llh_lsjm_interintraIDM_C1(arma::vec sharedtype, List HB, arma::vec Gompertz, arma::vec Weibull,
                                ...
                                arma::vec alpha_y_slope, List alpha_b, List alpha_z, List gamma, arma::vec beta, arma::vec beta_slope,
                                ...
                                arma::vec Time_T, arma::vec Time_L_R, arma::vec Time_T0,arma::mat st_T, arma::mat st_0_LR, arma::mat st_L_R, arma::mat st_T0,
                                arma::mat B_T_12,
                                arma::mat Bs_T_12,
                                arma::mat Bs_0_LR_01, arma::mat Bs_0_LR_02, arma::mat Bs_0_LR_12,
                                arma::mat Bs_L_R_01,
                                arma::mat Bs_T0_01, arma::mat Bs_T0_02,  bool left_trunc,
                                arma::vec len_visit, arma::mat X_base, arma::mat U_base,  arma::vec y_new, arma::vec offset_ID, int nbCase1,
  ...
  if(dep_var_inter_12){
    ...
    etaBaseline_12_0_LR_i_com = etaBaseline_12_0_LR_i_com + alpha_inter_12*sigma_inter;
  }
  if(dep_var_inter_02){
    etaBaseline_02_0_LR_i_com = etaBaseline_02_0_LR_i_com + alpha_inter_02*sigma_inter;
    if(left_trunc){
      etaBaseline_02_T0_i_com = etaBaseline_02_T0_i_com + alpha_inter_02*sigma_inter;
    }
  }
  if(dep_var_inter_01){
    etaBaseline_01_L_R_i_com = etaBaseline_01_L_R_i_com + alpha_inter_01*sigma_inter;
    etaBaseline_01_0_LR_i_com = etaBaseline_01_0_LR_i_com + alpha_inter_01*sigma_inter;
    if(left_trunc){
  ...
  if(dep_var_intra_12){
    ...
    etaBaseline_12_0_LR_i_com = etaBaseline_12_0_LR_i_com + alpha_intra_12*sigma_intra;
  }
  if(dep_var_intra_02){
    etaBaseline_02_0_LR_i_com = etaBaseline_02_0_LR_i_com + alpha_intra_02*sigma_intra;
    if(left_trunc){
      etaBaseline_02_T0_i_com = etaBaseline_02_T0_i_com + alpha_intra_02*sigma_intra;
    }
  }
  if(dep_var_intra_01){
    etaBaseline_01_L_R_i_com = etaBaseline_01_L_R_i_com + alpha_intra_01*sigma_intra;
    etaBaseline_01_0_LR_i_com = etaBaseline_01_0_LR_i_com + alpha_intra_01*sigma_intra;
    if(left_trunc){
  ...
  for(int i_provCase1 =0; i_provCase1 < nbCase1; ++i_provCase1){
    ...
    if(dep_re_01){
      survLong_01_L_R_i = survLong_01_L_R_i + arma::repmat(b_y*alpha_b_01,1,nb_pointsGK);
      survLong_01_0_LR_i = survLong_01_0_LR_i + arma::repmat(b_y*alpha_b_01,1,nb_pointsGK*nb_pointsGK);
      if(left_trunc){
    ...
    if(dep_re_02){
      survLong_02_0_LR_i = survLong_02_0_LR_i + arma::repmat(b_y*alpha_b_02,1,nb_pointsGK*nb_pointsGK);
      if(left_trunc){
        survLong_02_T0_i = survLong_02_T0_i + arma::repmat(b_y*alpha_b_02,1,nb_pointsGK);
      }
    }
    if(dep_re_12){
      survLong_12_0_LR_i = survLong_12_0_LR_i + arma::repmat(b_y*alpha_b_12,1,nb_pointsGK*nb_pointsGK);
    ...
    double len_visit_i = len_visit(i_provCase1+1);
    arma::vec offset_ID_i = offset_ID.subvec(offset_position(i_provCase1)-1, offset_position(i_provCase1+1)-2);
