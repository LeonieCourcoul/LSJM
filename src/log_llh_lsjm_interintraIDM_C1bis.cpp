...
arma::vec log_llh_lsjm_interintraIDM_C1bis(arma::vec sharedtype, List HB, arma::vec Gompertz, arma::vec Weibull,
                                   ...
                                   arma::vec Time_T, arma::vec Time_L, arma::vec Time_T0,arma::mat st_T, arma::mat st_L, arma::mat st_T0,
                                   arma::mat B_T_12,
                                   arma::mat Bs_T_12,
                                   arma::mat B_L_01,
                                   arma::mat Bs_L_01, arma::mat Bs_L_02, arma::mat Bs_L_12,
                                   arma::mat Bs_T0_01, arma::mat Bs_T0_02, bool left_trunc,
                                   arma::vec len_visit, arma::mat X_base, arma::mat U_base,  arma::vec y_new, arma::vec offset_ID, int nbCase1bis,
  ...
  if(dep_var_inter_01){
    h_01_L_i_com = h_01_L_i_com%exp(alpha_inter_01*sigma_inter);
    etaBaseline_01_L_i_com = etaBaseline_01_L_i_com + alpha_inter_01*sigma_inter;
    if(left_trunc){
      etaBaseline_01_T0_i_com = etaBaseline_01_T0_i_com + alpha_inter_01*sigma_inter;
    }
  }
  if(dep_var_inter_02){
    etaBaseline_02_L_i_com = etaBaseline_02_L_i_com + alpha_inter_02*sigma_inter;
    if(left_trunc){
  ...
  if(dep_var_inter_12){
    ...
    etaBaseline_12_L_i_com = etaBaseline_12_L_i_com + alpha_inter_12*sigma_inter;
    etaBaseline_12_T_i_com = etaBaseline_12_T_i_com + alpha_inter_12*sigma_inter;
  }

  if(dep_var_intra_01){
    h_01_L_i_com = h_01_L_i_com%exp(alpha_intra_01*sigma_intra);
    etaBaseline_01_L_i_com = etaBaseline_01_L_i_com + alpha_intra_01*sigma_intra;
    if(left_trunc){
      etaBaseline_01_T0_i_com = etaBaseline_01_T0_i_com + alpha_intra_01*sigma_intra;
    }
  }
  if(dep_var_intra_02){
    etaBaseline_02_L_i_com = etaBaseline_02_L_i_com + alpha_intra_02*sigma_intra;
    if(left_trunc){
  ...
  if(dep_var_intra_12){
    ...
    etaBaseline_12_L_i_com = etaBaseline_12_L_i_com + alpha_intra_12*sigma_intra;
  ...
  for(int i_provCase1bis = 0; i_provCase1bis < nbCase1bis; ++i_provCase1bis ){
    ...
    double len_visit_i = len_visit(i_provCase1bis+1);
    arma::vec offset_ID_i = offset_ID.subvec(offset_position(i_provCase1bis)-1, offset_position(i_provCase1bis+1)-2);
