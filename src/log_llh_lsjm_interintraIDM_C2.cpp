...
arma::vec log_llh_lsjm_interintraIDM_C2(arma::vec sharedtype, List HB, arma::vec Gompertz, arma::vec Weibull,
                                ...
                                arma::vec len_visit, arma::mat X_base, arma::mat U_base,  arma::vec y_new, arma::vec offset_ID, int nbCase2,
  ...
  for(int i_provCase2 =0; i_provCase2 < nbCase2; ++i_provCase2){
    ...
    double len_visit_i = len_visit(i_provCase2+1);
    arma::vec offset_ID_i = offset_ID.subvec(offset_position(i_provCase2)-1, offset_position(i_provCase2+1)-2);
