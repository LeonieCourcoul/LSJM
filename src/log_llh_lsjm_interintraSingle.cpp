...
arma::vec log_llh_lsjm_interintraSingle(arma::vec sharedtype, List HB, arma::vec Gompertz, arma::vec Weibull,
                                        ...
                                        arma::vec len_visit, arma::mat X_base, arma::mat U_base,  arma::vec y_new, arma::vec offset_ID, int Ind,
                                        arma::vec offset, arma::vec offset_position, arma::mat B_T_01 , arma::mat Bs_T_01
){
  // parameters
  ...
  double alpha_intra_01 = alpha_inter_intra[1];
  ...
  if(dep_var_inter_01){
    h_01_T_i_com = h_01_T_i_com%exp(alpha_inter_01*sigma_inter);
  ...
  if(dep_var_intra_01){
    h_01_T_i_com = h_01_T_i_com%exp(alpha_intra_01*sigma_intra);
