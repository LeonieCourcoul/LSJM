...
double re_lsjm_covDepIDMCase1Bis_cpp(arma::vec sharedtype, List HB, arma::vec W_G,
                                      double nb_pointsGK,
                                      ...
                                      arma::rowvec X_L_i, arma::rowvec U_L_i,
                                      arma::rowvec Xslope_L_i, arma::rowvec Uslope_L_i, arma::rowvec O_L_i, arma::rowvec W_L_i,
                                      arma::mat X_GK_L_i, arma::mat U_GK_L_i, arma::mat Xslope_GK_L_i,
                                      arma::mat Uslope_GK_L_i, arma::mat O_GK_L_i, arma::mat W_GK_L_i,
                                      ...
                                      List list_Times,arma::vec st_T_i, arma::vec st_L_i, arma::vec st_T0_i,
                                      arma::vec B_T_i_12,
                                      arma::mat Bs_T_i_12,
                                      arma::vec B_L_i_01,
  ...
  if(dep_re_01){
    survLong_01_L_i = survLong_01_L_i + arma::repmat(alpha_b_01*b_y,1,nb_pointsGK);
    h_01_L_i = h_01_L_i%exp(alpha_b_01*b_y);
    if(left_trunc){
  ...
  if(dep_re_02){
    survLong_02_L_i = survLong_02_L_i + arma::repmat(alpha_b_02*b_y,1,nb_pointsGK);
    if(left_trunc){
  ...
  if(dep_re_12){
    ...
    survLong_12_L_i = survLong_12_L_i + arma::repmat(alpha_b_12*b_y,1,nb_pointsGK);
  ...
  if(dep_var_01 || dep_var_02 || dep_var_12){
    ...
    Sigma_L = exp(arma::dot(omega, O_L_i) + W_L_i*tau_re);
    sigma_GK_L = exp(O_GK_L_i*omega+W_GK_L_i*tau_re);
    if(left_trunc){
      sigma_GK_T0 = exp(O_GK_T0_i*omega+W_GK_T0_i*tau_re);
    }
    if(dep_var_01){
      h_01_L_i = h_01_L_i%exp(alpha_var_01*Sigma_L);
      survLong_01_L_i = survLong_01_L_i + alpha_var_01*sigma_GK_L.t();
      if(left_trunc){
        survLong_01_T0_i = survLong_01_T0_i + alpha_var_01*sigma_GK_T0.t();
      }
    }
    if(dep_var_02){
      survLong_02_L_i = survLong_02_L_i + alpha_var_02*sigma_GK_L.t();
      if(left_trunc){
    ...
    if(dep_var_12){
      ...
      survLong_12_L_i = survLong_12_L_i + alpha_var_12*sigma_GK_L.t();
