...
double re_lsjm_covDepIDMCase1_cpp(arma::vec sharedtype, List HB, arma::vec W_G,
                                   double nb_pointsGK,
                                   ...
                                   arma::mat X_GK_L_R_i, arma::mat U_GK_L_R_i, arma::mat Xslope_GK_L_R_i, arma::mat Uslope_GK_L_R_i, arma::mat O_GK_L_R_i, arma::mat W_GK_L_R_i,
                                   arma::mat X_GK_0_LR_i, arma::mat U_GK_0_LR_i, arma::mat Xslope_GK_0_LR_i, arma::mat Uslope_GK_0_LR_i, arma::mat O_GK_0_LR_i, arma::mat W_GK_0_LR_i,
                                   ...
                                   List list_Times,arma::vec st_T_i, arma::mat st_0_LR_i, arma::vec st_L_R_i, arma::vec st_T0_i,
                                   arma::vec B_T_i_12,
                                   arma::mat Bs_T_i_12,
  ...
  if(dep_var_01 || dep_var_02 || dep_var_12){
    ...
    if(dep_var_01){
      survLong_01_L_R_i = survLong_01_L_R_i + alpha_var_01*sigma_GK_L_R.t();
      survLong_01_0_LR_i = survLong_01_0_LR_i + alpha_var_01*sigma_GK_0_LR.t();
      if(left_trunc){
        survLong_01_T0_i = survLong_01_T0_i + alpha_var_01*sigma_GK_T0.t();
      }
    }
    if(dep_var_02){
      survLong_02_0_LR_i = survLong_02_0_LR_i + alpha_var_02*sigma_GK_0_LR.t();
      if(left_trunc){
        survLong_02_T0_i = survLong_02_T0_i + alpha_var_02*sigma_GK_T0.t();
      }
    }
    if(dep_var_12){
      survLong_12_0_LR_i = survLong_12_0_LR_i + alpha_var_12*sigma_GK_0_LR.t();
