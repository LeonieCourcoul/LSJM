...
double re_lsjm_covDepIDMCase3_cpp(arma::vec sharedtype, List HB, arma::vec W_G,
                                   ...
                                   arma::mat X_GK_L_T_i, arma::mat U_GK_L_T_i, arma::mat Xslope_GK_L_T_i, arma::mat Uslope_GK_L_T_i, arma::mat O_GK_L_T_i, arma::mat W_GK_L_T_i,
                                   arma::mat X_GK_0_LT_i, arma::mat U_GK_0_LT_i, arma::mat Xslope_GK_0_LT_i, arma::mat Uslope_GK_0_LT_i, arma::mat O_GK_0_LT_i, arma::mat W_GK_0_LT_i,
                                   ...
                                   List list_Times, arma::vec st_T_i, arma::mat st_0_LT_i, arma::vec st_L_T_i, arma::vec st_T0_i,
                                   ...
                                   arma::mat Bs_T0_i_01, arma::mat Bs_T0_i_02,
  ...
  double Time_T0_i = list_Times[2];
  double delta2_i = list_Times[3];
  ...
  if(dep_cv_01 || dep_cv_02 || dep_cv_12){
    ...
    current_GK_L_T = X_GK_L_T_i*beta+U_GK_L_T_i*b_y;
    current_GK_0_LT = X_GK_0_LT_i*beta+U_GK_0_LT_i*b_y;
    if(left_trunc){
      current_GK_T0 =  X_GK_T0_i*beta+U_GK_T0_i*b_y;
    }
    if(dep_cv_01){
      survLong_01_T_i = survLong_01_T_i + alpha_y_01*current_GK_T.t();
      survLong_01_L_T_i = survLong_01_L_T_i + alpha_y_01*current_GK_L_T.t();
      survLong_01_0_LT_i = survLong_01_0_LT_i + alpha_y_01*current_GK_0_LT.t();
      if(left_trunc){
    ...
    if(dep_cv_02){
      ...
      survLong_02_0_LT_i = survLong_02_0_LT_i + alpha_y_02*current_GK_0_LT.t();
      if(left_trunc){
        survLong_02_T0_i = survLong_02_T0_i + alpha_y_02*current_GK_T0.t();
      }
    }
    if(dep_cv_12){
      survLong_12_0_LT_i = survLong_12_0_LT_i + alpha_y_12*current_GK_0_LT.t();
  ...
  if(dep_slope_01 || dep_slope_02 || dep_slope_12){
    ...
    slope_GK_L_T = Xslope_GK_L_T_i*beta_slope+Uslope_GK_L_T_i*b_y_slope;
    slope_GK_0_LT = Xslope_GK_0_LT_i*beta_slope+Uslope_GK_0_LT_i*b_y_slope;
    if(left_trunc){
    ...
    if(dep_slope_01){
      ...
      survLong_01_L_T_i = survLong_01_L_T_i + alpha_slope_01*slope_GK_L_T.t();
      survLong_01_0_LT_i = survLong_01_0_LT_i + alpha_slope_01*slope_GK_0_LT.t();
      if(left_trunc){
    ...
    if(dep_slope_02){
      ...
      survLong_02_0_LT_i = survLong_02_0_LT_i + alpha_slope_02*slope_GK_0_LT.t();
      if(left_trunc){
        survLong_02_T0_i = survLong_02_T0_i + alpha_slope_02*slope_GK_T0.t();
      }
    }
    if(dep_slope_12){
      survLong_12_0_LT_i = survLong_12_0_LT_i + alpha_slope_12*slope_GK_0_LT.t();
  ...
  if(dep_var_01 || dep_var_02 || dep_var_12){
    ...
    sigma_GK_L_T = O_GK_L_T_i*omega+W_GK_L_T_i*tau_re;
    sigma_GK_0_LT = O_GK_0_LT_i*omega+W_GK_0_LT_i*tau_re;
    if(left_trunc){
      current_GK_T0 =  O_GK_T0_i*omega+W_GK_T0_i*tau_re;
    }
    if(dep_var_01){
      survLong_01_T_i = survLong_01_T_i + alpha_var_01*sigma_GK_T.t();
      survLong_01_L_T_i = survLong_01_L_T_i + alpha_var_01*sigma_GK_L_T.t();
      survLong_01_0_LT_i = survLong_01_0_LT_i + alpha_var_01*sigma_GK_0_LT.t();
      if(left_trunc){
    ...
    if(dep_var_02){
      ...
      survLong_02_0_LT_i = survLong_02_0_LT_i + alpha_var_02*sigma_GK_0_LT.t();
      if(left_trunc){
        survLong_02_T0_i = survLong_02_T0_i + alpha_var_02*sigma_GK_T0.t();
      }
    }
    if(dep_var_12){
      survLong_12_0_LT_i = survLong_12_0_LT_i + alpha_var_12*sigma_GK_0_LT.t();
      survLong_12_T_i = survLong_12_T_i + alpha_var_12*sigma_GK_T.t();
